...
//					],
					[
						'value'=>function(User $model){
								return GhostHtml::a(
									...
									['class'=>'btn btn-xs btn-primary', 'data-pjax'=>0]);
							},
						'format'=>'raw',
						//'visible'=>User::canRoute('/user-management/user-permission/set'),
						'visible'=>User::hasRole('10'),
						'options'=>[
							'width'=>'10px',
						],
					],
					[
						'value'=>function(User $model){
								return GhostHtml::a(
									...
									['class'=>'btn btn-xs btn-default', 'data-pjax'=>0]);
							},
						'format'=>'raw',
						'options'=>[
							'width'=>'10px',
					...
					[
						...
						'optionsArray'=>[
							...
							[User::STATUS_INACTIVE, UserManagementModule::t('back', 'Deactive'), 'warning'],
